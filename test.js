...
//         var fileName = part[i].slice(0, -5);

//         const fileTemp = fs.readFileSync('views/partials/' + fileName + '.html', 'utf-8');
//         handlebars.registerPartial(fileName, fileTemp);

//         console.log('Aktuell verarbeitet: ' + fileName);
